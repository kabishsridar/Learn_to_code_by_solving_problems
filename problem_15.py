...
def can_arrange_boxes(box_list):
    ...
    if number_of_boxes == 1:
        ...
        # First arrangement: combine box 1 followed by box 2
    ...
    # If there are more than two boxes, we print a message that the code can't handle it
    else:
        print("Too many boxes to check with this simple code")
        

boxes_one = [[4, 5, 7], [1, 2]]
print(can_arrange_boxes(boxes_one))

boxes_two = [[4, 5, 7], [6, 8]]
print(can_arrange_boxes(boxes_two))