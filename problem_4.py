num1=int(input("First Integer: "))  # getting the integers of phone number one by one and be stored as a variable num1
num2=int(input("Second Integer: ")) 
num3=int(input("Third Integer: "))
num4=int(input("Fourth Integer: "))

print(num1,num2,num3,num4) # it will display all those numbers in one line for better readability
if (num1==8 or num1==9) and (num4==8 or num4==9) and (num3==num2): # it checks and prints ignore if the first and last numbers both are either 8 or 9 and also the second and third numbers are same
    print("ignore")
else:
    print("answer")  #it prints answer if the if statement is false
'''
# We can also use the below format by using split function so that the user can type in single line using spaces and it can be faster
